...
function Component() {
  return (
    <section className="burger-drums">
      <BurgerDrum />

      <Credit
        author="Steve Gardner"
        twitter="https://twitter.com/steeevg"
        codepen="https://codepen.io/ste-vg/pen/MWpxKYR"
        youtube="https://youtu.be/VtmsuVT7BGI"
      />
    </section>
  );
}
    ...
    <div className={`burger-drum ${view}`}>
      ...
      <div className="info">
        ...
        <p className="description">
          Our signature burger, inspired by legendary drummer{" "}
          <i>[your favorite drummer here]</i>. Order online now{" "}
          <i>(or don't because this is all pretend)</i> or transform this burger
          into a drum kit and play some sweet beats!
        </p>
      ...
      <div className="controls">
        ...
        <div>
          Tap the drums or use these keyboard keys: <span>Q</span>
          <span>W</span>
          <span>E</span>
          <span>R</span>
          <span>T</span>
...
class Manager {
  ...
  moveToDrums() {
    ...
    Object.keys(this.models.burger.items).forEach((key) => {
      ...
      gsap.to(item.position, {
        motionPath: [
          { x: pos.position.x, y: pos.position.y + 0.5, z: pos.position.z },
          { ...pos.position },
        ],
        delay,
        duration: 1,
  ...
  moveToBurger() {
    gsap.to(this.stage.camera.position, {
      ...this.stage.camera.home.position,
      duration: 0.6,
    });
